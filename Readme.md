...
```
npm install class-validator cors dotenv express morgan mysql ejs typeorm typeorm-naming-strategies typescript middleware  passport-jwt  passport-local middleware  passport-jwt passport-local
``
```
